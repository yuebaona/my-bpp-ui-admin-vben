...
在 `yudao-module-bpm-server` 模块的 [`pom.xml`](https://github.com/YunaiV/yudao-cloud/blob/master/yudao-module-bpm/yudao-module-bpm-server/pom.xml#L30-L34)，引入 `yudao-module-system-api` 模块的依赖。代码如下：
