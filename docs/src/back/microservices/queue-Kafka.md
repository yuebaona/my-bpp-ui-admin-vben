...
`bpp-spring-boot-starter-mq`技术组件，基于 Kafka 实现分布式消息队列。
...
② 修改 `bpp-spring-boot-starter-mq` 的 `pom.xml` 文件，引入 `spring-kafka` 依赖。如下所示：
...
![image](http://rsim.portsgmt.com:9001/bgbpp-vben/7fd4edf9-86c0-4c46-9349-451c508bdaf6.png)
