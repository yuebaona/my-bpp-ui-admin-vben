...
![image](http://rsim.portsgmt.com:9001/bgbpp-vben/95b00e4a-cf84-4266-965d-9c5c13aa396a.png)

### 2.2 编辑配置

点击 `system_group` 所在行的 \[编辑\] 按钮，修改生成配置。后操作如下：

![image](http://rsim.portsgmt.com:9001/bgbpp-vben/1a71315b-cf6e-4907-b116-dfc6e486a9c6.png)

![image](http://rsim.portsgmt.com:9001/bgbpp-vben/9c0cd61a-c301-4b6d-81b9-d98c6e8bea80.png)
...
![image](http://rsim.portsgmt.com:9001/bgbpp-vben/0e239e91-0f72-40e4-9dc9-05a8005ac093.png)
...
![image](http://rsim.portsgmt.com:9001/bgbpp-vben/c8969f92-1e9c-40db-9cdd-efb40c5691ea.png)
...
![image](http://rsim.portsgmt.com:9001/bgbpp-vben/cc91e773-65cb-47a0-b745-685a7d745ca7.png)

② 将 `ErrorCodeConstants.java_手动操作` 文件的错误码，复制到该模块 ErrorCodeConstants 类中，并设置对应的错误码编号，之后进行删除。操作如下图所示：

![image](http://rsim.portsgmt.com:9001/bgbpp-vben/d0d553cc-6548-4810-88a3-cf35b4b10235.png)
...
![image](http://rsim.portsgmt.com:9001/bgbpp-vben/7fe371d4-5b10-4437-bf16-1da7b6613834.png)

⑤ Debug 运行 SystemServerApplication 类，启动后端项目。通过 IDEA 的 \[Mappings\] 菜单，可以看到代码生成的 GroupController 的 RESTful API 接口已经生效。

![image](http://rsim.portsgmt.com:9001/bgbpp-vben/8ae87b7d-3606-4df2-b3da-0fc213f24109.png)

### 3.2 前端运行

① 将生成的前端代码，复制到项目中。操作如下图所示：

![image](http://rsim.portsgmt.com:9001/bgbpp-vben/a88cced9-e4aa-4849-8644-d8b663364fc4.png)

② **重新**执行 `npm run dev` 命令，启动前端项目。点击 \[系统管理 -> 菜单管理\] 菜单，点击【刷新菜单缓存】，因为前端项目会缓存菜单在内存中的，所以需要刷新一下。

③ 点击 \[系统管理 -> 用户组管理\] 菜单，就可以看到用户组的 UI 界面。

![image](http://rsim.portsgmt.com:9001/bgbpp-vben/7ea1dcf9-6dbe-4075-942f-22de582b03cf.png)
