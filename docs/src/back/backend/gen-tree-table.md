...
![image](http://rsim.portsgmt.com:9001/bgbpp-vben/3f27679c-1533-48eb-b84b-a4b248f69197.png)

例如说：部门、分类等，是一个树形结构。我们可以通过树形结构，来展示部门、分类的层级关系。

下面，将演示“树表”的使用，基于代码生成器，在 `yudao-module-system` 模块中，开发一个【**分类**】的功能。
...
![image](http://rsim.portsgmt.com:9001/bgbpp-vben/15894b35-c151-4755-b9fc-e69c024eb2d5.png)
