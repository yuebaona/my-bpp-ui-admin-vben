...
| Resource 工具 | [ResourceUtil(opens new window)](https://plus.hutool.cn/apidocs/cn/hutool/core/io/resource/ResourceUtil.html) |  |
...
| 校验工具 | [ValidationUtil(opens new window)](https://plus.hutool.cn/apidocs/cn/hutool/extra/validation/ValidationUtil.html) | [ValidationUtils(opens new window)](https://github.com/YunaiV/yudao-cloud/blob/master/yudao-framework/yudao-common/src/main/java/cn/iocoder/yudao/framework/common/util/validation/ValidationUtils.java) |
