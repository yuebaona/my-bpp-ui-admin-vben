...
![image](http://rsim.portsgmt.com:9001/bgbpp-vben/f81ecb42-4a7e-4c09-ac88-6af58bc6ecc5.png)
...
![image](http://rsim.portsgmt.com:9001/bgbpp-vben/b52c98ea-245b-4627-a689-511cbd237477.png)

② 访问 \[系统管理 -> 岗位管理\] 菜单，查看 IDEA 控制台，可以看到 `system_post` 表的查询自动拼接了 `AND updater = 1` 的查询条件。

![image](http://rsim.portsgmt.com:9001/bgbpp-vben/4921431b-b8f8-4bd2-8bac-7a6ddfff8ace.png)
