...
// 配置信息分页查询
export const getSettingsPage = (params: PageParam) => {
...
// 创建配置信息
export const createSettings = (data: VehicleManagementApi.vehicleVO) => {
...
// 修改配置信息
export const updateSettings = (data: VehicleManagementApi.vehicleVO) => {
